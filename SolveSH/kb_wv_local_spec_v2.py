...
logfile = open(os.getcwd()+"/logs/kb_wv_local_v2_{}.out".format(mu), 'w')
sys.stdout = logfile
...
plt.savefig(os.getcwd()+"/figs/local_spec_v2/"+"approx_quiver_mu_{}.png".format(mu))
...
plt.tight_layout()
plt.savefig(os.getcwd()+"/figs/local_spec_v2/"+"kx_mu_{}.png".format(mu))
plt.close()
...
plt.colorbar(im2, ax=ax[1])
plt.tight_layout()
plt.savefig(os.getcwd()+"/figs/local_spec_v2/"+"ky_mu_{}.png".format(mu))
plt.close()
...
plt.colorbar(im2, ax=ax[1])
plt.tight_layout()
plt.savefig(os.getcwd()+"/figs/local_spec_v2/"+"wave_nums_mu_{}.png".format(mu))
plt.close()
...
plt.tight_layout()
plt.savefig(os.getcwd()+"/figs/local_spec_v2/"+"linearized_phases_mu_{}.png".format(mu))
plt.close()
...
plt.colorbar(im3, ax=ax[2])
plt.tight_layout()
plt.savefig(os.getcwd()+"/figs/local_spec_v2/"+"grad_descent_field_compare_mu_{}.png".format(mu))
plt.close()
...
plt.colorbar(im3, ax=ax[2])
plt.tight_layout()
plt.savefig(os.getcwd()+"/figs/local_spec_v2/"+"grad_descent_kx_compare_mu_{}.png".format(mu))
plt.close()
...
plt.colorbar(im3, ax=ax[2])
plt.tight_layout()
plt.savefig(os.getcwd()+"/figs/local_spec_v2/"+"grad_descent_ky_compare_mu_{}.png".format(mu))
plt.close()
...
plt.colorbar(im3, ax=ax[2])
plt.tight_layout()
plt.savefig(os.getcwd()+"/figs/local_spec_v2/"+"grad_descent_wavenum_compare_mu_{}.png".format(mu))
plt.close()
